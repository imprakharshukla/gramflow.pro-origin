...
const HeroComponent = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="outfit relative overflow-hidden border-b border-white/5">
          ...
          >
            <div className="flex flex-row items-center justify-between text-sm text-black lg:justify-start">
              ...
              <button
                ...
                className="inline-flex items-center justify-center p-2 text-black hover:text-black focus:text-black focus:outline-none md:hidden"
              >
                <svg
                  className="h-6 w-6"
                  fill="none"
            ...
            <nav
              className={`flex-grow flex-col items-center md:flex md:flex-row md:justify-end md:space-x-6 md:pb-0 ${
                open ? "flex" : "hidden"
              }`}
            >
              <a
              ...
              <a className="group justify-center rounded-full bg-black/5 px-6 py-2 text-sm font-semibold text-black hover:bg-black/5 hover:text-black focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-fuchsia-50 active:bg-fuchsia-50 active:text-black">
                Pricing
              </a>
            </nav>
          </div>
      ...
      <div className="relative flex items-center justify-center">
        <div className="relative mx-auto w-full max-w-7xl items-center px-5 py-12 md:px-12 lg:px-16 lg:py-36">
          <div>
            <div className="text-center">
              {/* Your content */}
              <span className="w-auto rounded-full px-4 py-2 text-xl text-black">
              ...
              , olé!
              <p className="mt-8 text-4xl font-bold tracking-tight text-black md:text-7xl">
                Create presentation slides with AI{" "}
                <span className="text-black">in seconds</span>
              </p>
              <p className="mx-auto mt-4 max-w-3xl text-base text-black/80 lg:text-xl">
                Let the AI write the outline and presentation content for you.
                With our tool, you can easily create professional, engaging
                slides from any text in no time.
              </p>
              <div className="mt-10 flex flex-col justify-center gap-3 sm:flex-row">
                <a
                  className="inline-flex w-full items-center justify-center rounded-full bg-black px-6 py-3 text-center font-medium text-white duration-200 hover:bg-black/20 hover:text-black focus:outline-none focus-visible:outline-black focus-visible:ring-black lg:w-auto"
                  href="#_"
                >
                  Install SlidesAI for Google Slides
                </a>
                <a
                  className="inline-flex w-full items-center justify-center rounded-full border border-white/5 bg-black/5 px-6 py-3 text-center font-medium text-black duration-200 hover:bg-white/20 hover:text-black focus:outline-none focus-visible:outline-black focus-visible:ring-black lg:w-auto"
                  href="#_"
                >
                  <svg
          ...
          <div className="relative mx-auto mt-24 hidden w-full max-w-7xl items-center pb-12">
            <div>
              <div
              ...
              >
                <video
                  autoPlay
                  className="bg-[#f6f0ec] shadow-2xl lg:rounded-2xl"
                  height="100%"
                  loop
                  muted
                  playsInline
                ...
                >
                  <source
                    src="https://www.slidesai.io/slidesai-preview-video.mp4"
                    type="video/mp4"
                  />
