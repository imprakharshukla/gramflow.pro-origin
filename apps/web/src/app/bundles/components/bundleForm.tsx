  ...
  return (
    <div className="p-2 pb-10 text-justify md:p-10">
      ...
      >
        ...
        {formStage == FormState.OtpSent && <h1 className="mt-5">Verify OTP</h1>}
        {formStage == FormState.Success && (
        ...
        <Form {...form}>
          ...
          >
            <ul className="heart-bullet-list not-prose mt-4 space-y-3 text-justify">
              ...
              <li>
                It might take <strong> 15-20 days or more </strong>to gather the
                items for your special bundle, depending on your request.
              </li>
              <li>
                <strong>Payments are split into two parts</strong>: you pay the
                first half when we finalize the details after you fill out the
                form, and the second half is due just before we ship your order.
              </li>
              <li>
              ...
              <li>
                ...
                refunds or cancellations are not possible. Additionally, please
                be informed that we do not support Cash on Delivery.
              </li>
            </ul>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel>
                      {" "}
                      I have read the terms and conditions carefully and I agree
                      to them.{" "}
                    </FormLabel>
                  </div>
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Please select your bundle size. The numbers in the brackets
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Please enter any links to items you like. You can paste the
                    links to a Google Doc, Pinterest board, iCloud Photo Album,
                    etc.
                  </FormDescription>
                  <FormControl>
                    <Input
