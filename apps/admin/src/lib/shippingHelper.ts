      ...
      try {
        ...
        orders.map(async (order, index) => {
          ...
          const shipment = delhiveryShipmentSchema.parse({
            ...
            payment_mode: AppConfig.DefaultPackageDetails.payment_mode,
            return_pin: "",
            return_city: "",
            return_phone: "",
            return_add: "",
            ...
            quantity: "",
            waybill: "",
            shipment_width: AppConfig.DefaultPackageDetails.weight,
            shipment_length: AppConfig.DefaultPackageDetails.length,
            shipment_height: AppConfig.DefaultPackageDetails.height,
            weight: AppConfig.DefaultPackageDetails.weight,
            seller_gst_tin: "",
